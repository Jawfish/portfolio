...
export const meta = {
  ...
  title: 'PyWinModal',
  description:
    'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ducimus nulla aut dolor maxime asperiores iste omnis nemo optio velit? Repellendus illo, ad quidem sequi itaque odio accusantium porro deserunt nemo quam voluptatibus obcaecati. Et repellendus facilis impedit. Sunt, placeat porro!',
}
