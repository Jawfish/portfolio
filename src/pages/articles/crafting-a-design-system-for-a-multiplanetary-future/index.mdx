...
export const meta = {
  ...
  title: 'Rebook',
  description:
    'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Assumenda veritatis vel facere error rem eius ipsa architecto ab, aut libero excepturi voluptas dicta inventore ducimus. Ratione cupiditate ad nam. Alias inventore unde temporibus reprehenderit debitis quo iure magni similique reiciendis porro, at fugiat molestias, dolorum amet deserunt in modi beatae.'
}
