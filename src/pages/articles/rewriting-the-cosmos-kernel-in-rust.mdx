...
export const meta = {
  ...
  title: 'Connexit',
  description:
    'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nemo natus provident repudiandae nostrum vitae, obcaecati ipsam molestias distinctio, accusamus non cum. Voluptate amet facere impedit hic maiores dicta unde non asperiores tempore consequuntur, distinctio nostrum obcaecati odit porro ipsum illo officiis suscipit totam est similique?',
}
